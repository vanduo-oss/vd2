...
const shadowUtils = ["vd-shadow-none vd-border", "vd-shadow-sm", "vd-shadow", "vd-shadow-md", "vd-shadow-lg", "vd-shadow-xl", "vd-shadow-2xl"];
const shadowLabel = (cls: string): string => "." + (cls.split(" ")[0]?.replace("vd-", "") ?? "");
      ...
      <div class="vd-row">
        <div class="vd-col-12">
          <div class="vd-card vd-card-glow demo-card vd-mb-8">
            <div class="vd-card-header"><h6>Fibonacci elevation ladder</h6></div>
            <div class="vd-card-body">
              <div class="vd-alert vd-alert-info vd-mb-6">
                <i class="ph ph-info"></i>
                <div>
                  <strong>Each level's Y-offset and blur are a Fibonacci pair.</strong>
              ...
              <div class="vd-row">
                <div v-for="el in elevations" :key="el.cls" class="vd-col-6 vd-col-md-4 vd-col-lg-2 vd-mb-5">
                  <div
                    :class="`${el.cls} vd-p-5 vd-rounded-md vd-text-center`"
                    :style="el.flat ? 'background: var(--vd-bg-primary); border: 1px solid var(--vd-border-color);' : 'background: var(--vd-bg-primary);'"
                  >
                    <code class="vd-text-sm">.{{ el.cls }}</code>
                    <div class="vd-mt-2"><span class="vd-badge vd-badge-secondary">{{ el.badge }}</span></div>
                  </div>
                </div>
              </div>
              <p class="vd-text-sm vd-text-muted vd-mb-0">
                The same pairs drive the <code>.vd-shadow-*</code> utilities below
                (<code>.vd-shadow-2xl</code> reaches 21/34). These proportions come
                from the <RouterLink to="/core/golden-ratio">Golden Ratio</RouterLink> system.
              </p>
            </div>
          </div>
        </div>
          ...
          <div class="vd-card vd-card-glow demo-card">
            ...
            <div class="vd-card-body">
              ...
              <div class="vd-d-flex vd-flex-col vd-gap-4">
                <div class="vd-p-4 vd-rounded-md vd-glow vd-hover-glow" style="background: var(--vd-bg-primary); border: 1px solid var(--vd-border-color)">
                  <code>.glow</code> or <code>.glow-primary</code> - permanent glow
                </div>
                <div class="vd-p-4 vd-rounded-md vd-hover-glow" style="background: var(--vd-bg-primary); border: 1px solid var(--vd-border-color)">
                  <code>.hover-glow</code> - glow on hover only
                </div>
                <div class="vd-p-4 vd-rounded-md vd-hover-glow-success" style="background: var(--vd-bg-primary); border: 1px solid var(--vd-border-color)">
                  <code>.hover-glow-success</code> - green glow
                </div>
                <div class="vd-p-4 vd-rounded-md vd-hover-glow-warning" style="background: var(--vd-bg-primary); border: 1px solid var(--vd-border-color)">
                  <code>.hover-glow-warning</code> - yellow glow
                </div>
                <div class="vd-p-4 vd-rounded-md vd-hover-glow-error" style="background: var(--vd-bg-primary); border: 1px solid var(--vd-border-color)">
      ...
      <div class="vd-row">
        <div class="vd-col-12">
          <div class="vd-card vd-card-glow demo-card">
            ...
            <div class="vd-card-body">
              <p class="vd-mb-4">Control the glow intensity with size variants:</p>
              <div class="vd-d-flex vd-flex-wrap vd-gap-5">
                <div class="vd-p-4 vd-rounded-md vd-hover-glow-sm" style="background: var(--vd-bg-primary); border: 1px solid var(--vd-border-color)">
                  <code>.hover-glow-sm</code><br /><small>Subtle (10px blur)</small>
                </div>
                <div class="vd-p-4 vd-rounded-md vd-hover-glow-md" style="background: var(--vd-bg-primary); border: 1px solid var(--vd-border-color)">
                  <code>.hover-glow-md</code><br /><small>Medium (20px blur)</small>
                </div>
                <div class="vd-p-4 vd-rounded-md vd-hover-glow-lg" style="background: var(--vd-bg-primary); border: 1px solid var(--vd-border-color)">
                  <code>.hover-glow-lg</code><br /><strong>Strong (30px blur)</strong>
                </div>
              </div>
        ...
        <div class="vd-col-12 vd-col-md-6">
          <div class="vd-card vd-card-glow demo-card">
            ...
            <div class="vd-card-body">
              ...
              <div class="vd-d-flex vd-flex-col vd-gap-3">
                <div class="vd-p-3 vd-rounded-md vd-shadow-primary vd-text-white vd-bg-primary"><code>.shadow-primary</code></div>
                <div class="vd-p-3 vd-rounded-md vd-shadow-success vd-text-white vd-bg-success"><code>.shadow-success</code></div>
                <div class="vd-p-3 vd-rounded-md vd-shadow-warning vd-bg-warning"><code>.shadow-warning</code></div>
                <div class="vd-p-3 vd-rounded-md vd-shadow-error vd-text-white vd-bg-error"><code>.shadow-error</code></div>
              </div>
            </div>
          </div>
        </div>
