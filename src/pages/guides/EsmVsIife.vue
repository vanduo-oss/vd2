  ...
  <DocsLayout>
    <section id="esm-vs-iife">
      ...
      <div class="vd-row vd-mb-6">
        <div class="vd-col-12 vd-col-md-4">
          <div class="vd-card demo-card">
            <div class="vd-card-header"><h6><i class="ph ph-file-html"></i> IIFE (no build)</h6></div>
        ...
        <div class="vd-col-12 vd-col-md-4">
          <div class="vd-card demo-card">
            <div class="vd-card-header"><h6><i class="ph ph-package"></i> ESM (bundler)</h6></div>
            <div class="vd-card-body">
        ...
        <div class="vd-col-12 vd-col-md-4">
          <div class="vd-card demo-card">
            <div class="vd-card-header"><h6><i class="ph ph-atom"></i> Vue (vd2)</h6></div>
            <div class="vd-card-body">
      ...
      <div class="vd-row vd-mb-6">
        <div class="vd-col-12">
          <div class="vd-card demo-card">
            <div class="vd-card-header"><h6><i class="ph ph-table"></i> Choosing a build</h6></div>
            <div class="vd-card-body">
              <div class="vd-table-responsive">
                <table class="vd-table vd-table-striped">
                  <thead><tr><th>Concern</th><th>IIFE</th><th>ESM / Vue</th></tr></thead>
                  <tbody>
      ...
      <div class="vd-card demo-card">
        <div class="vd-card-header"><h6><i class="ph ph-warning"></i> Common pitfall</h6></div>
        <div class="vd-card-body">
          <div class="vd-alert vd-alert-warning vd-mb-0">
            ...
            <div>
              ...
              are writing static HTML with no build step, use the IIFE bundle (or
              the CDN) instead. See <a href="/quick-start">Quick start</a>.
            </div>
          </div>
        </div>
      </div>
