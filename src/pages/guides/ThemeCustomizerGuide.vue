...
const attrs: [string, string, string][] = [
  ["data-theme", "system · light · dark", "Colour mode (system defers to prefers-color-scheme)"],
  ["data-primary", "18 hues (e.g. violet, teal)", "Brand colour ramp"],
  ["data-neutral", "6 ramps (e.g. slate, gray)", "Neutral / surface colours"],
  ["data-radius", "0 · 0.125 · 0.25 · 0.375 · 0.5", "Corner-radius scale (rem)"],
  ...
  <DocsLayout>
    <section id="theme-customizer-guide">
      ...
      <p class="vd-mb-6">
        ...
        <code>data-*</code> attributes on <code>&lt;html&gt;</code>. The legacy
      ...
      <div class="vd-row vd-mb-6">
        <div class="vd-col-12 vd-col-md-6">
          <div class="vd-card demo-card">
            <div class="vd-card-header"><h6><i class="ph ph-database"></i> Driving the store</h6></div>
        ...
        <div class="vd-col-12 vd-col-md-6">
          <div class="vd-card demo-card">
            <div class="vd-card-header"><h6><i class="ph ph-brackets-angle"></i> What it sets</h6></div>
            <div class="vd-card-body">
              <p>The store writes these attributes; the framework CSS does the rest:</p>
      ...
      <div class="vd-row vd-mb-6">
        <div class="vd-col-12">
          <div class="vd-card demo-card">
            <div class="vd-card-header"><h6><i class="ph ph-sliders"></i> Customization attributes</h6></div>
            <div class="vd-card-body">
              <div class="vd-table-responsive">
                <table class="vd-table vd-table-striped">
                  <thead><tr><th>Attribute</th><th>Values</th><th>Controls</th></tr></thead>
                  <tbody>
              ...
              <p class="vd-text-sm vd-text-muted vd-mt-3">
                ...
                <code>@vanduo-oss/core</code> so they match the legacy customizer
                exactly — see <a href="/guides/vanduo-ecosystem">The Vanduo Ecosystem</a>.
              </p>
            </div>
          </div>
        </div>
      ...
      <div class="vd-card demo-card">
        <div class="vd-card-header"><h6><i class="ph ph-floppy-disk"></i> Persistence</h6></div>
        <div class="vd-card-body">
          <DocCodeSnippet :js="persistJs" :default-open="true" />
          <p class="vd-text-sm vd-text-muted vd-mt-3">
            Try it live on the
            <a href="/components/theme-customizer">Theme Customizer</a> and
            <a href="/components/theme-switcher">Theme Switcher</a> component pages.
          </p>
        </div>
      </div>
    </section>
