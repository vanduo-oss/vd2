...
const practices: [string, string][] = [
  ["Content Security Policy", "vd2 ships no inline scripts, so a strict CSP just works."],
  ["Trusted v-html only", "Raw-HTML rendering is reserved for first-party static content."],
  ["Same-origin remote data", "Suggest fetches are restricted to same-origin or an explicit allowlist."],
  ["Dependency hygiene", "pnpm's strict lockfile + isolated node_modules limit supply-chain risk."],
  ["No secrets in the bundle", "Anything imported into the client is public — keep keys server-side."],
];
</script>
  ...
  <DocsLayout>
    <section id="security-practices">
      ...
      <div class="vd-row vd-mb-6">
        <div class="vd-col-12 vd-col-md-6">
          <div class="vd-card demo-card">
            <div class="vd-card-header"><h6><i class="ph ph-lock-key"></i> Content Security Policy</h6></div>
        ...
        <div class="vd-col-12 vd-col-md-6">
          <div class="vd-card demo-card">
            <div class="vd-card-header"><h6><i class="ph ph-globe-hemisphere-west"></i> Remote data is allow-listed</h6></div>
            <div class="vd-card-body">
      ...
      <div class="vd-row vd-mb-6">
        <div class="vd-col-12">
          <div class="vd-card demo-card">
            <div class="vd-card-header"><h6><i class="ph ph-code-block"></i> Treat v-html as a sharp tool</h6></div>
            <div class="vd-card-body">
      ...
      <div class="vd-card demo-card">
        <div class="vd-card-header"><h6><i class="ph ph-list-checks"></i> Checklist</h6></div>
        <div class="vd-card-body">
