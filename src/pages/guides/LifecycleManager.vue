...
const rules: [string, string][] = [
  ["Set up in onMounted", "DOM exists only after mount; this is the equivalent of Vanduo.init."],
  ["Tear down in onUnmounted", "Mirror every listener/observer/timer with a cleanup — the equivalent of Vanduo.destroy."],
  ["Collect teardowns in an array", "Push each cleanup as you create it so unmount can't miss one."],
  ["Guard window/document", "vite-ssg builds server-side; unguarded DOM access breaks the SSG build."],
  ["Append overlays to body", "Popups/portals appended to document.body must be removed in cleanup."],
];
</script>
  ...
  <DocsLayout>
    <section id="lifecycle-manager">
      ...
      <p class="vd-mb-6">
        ...
        cleanup is automatic and scoped to the component that created it.
      </p>

      <div class="vd-row vd-mb-6">
        <div class="vd-col-12">
          <div class="vd-card demo-card">
            <div class="vd-card-header"><h6><i class="ph ph-code"></i> The standard composable shape</h6></div>
      ...
      <div class="vd-row vd-mb-6">
        <div class="vd-col-12">
          <div class="vd-card demo-card">
            <div class="vd-card-header"><h6><i class="ph ph-checks"></i> Rules of thumb</h6></div>
            <div class="vd-card-body">
      ...
      <div class="vd-card demo-card">
        <div class="vd-card-header"><h6><i class="ph ph-shield-check"></i> Server-side rendering guard</h6></div>
        <div class="vd-card-body">
          <p>
          ...
          <p class="vd-text-sm vd-text-muted vd-mt-3">
            Related: <a href="/guides/runtime-architecture">Runtime architecture</a>
            and <a href="/guides/production-best-practices">Production best practices</a>.
          </p>
        </div>
      </div>
    </section>
