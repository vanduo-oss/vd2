...
const practices: [string, string][] = [
  ...
  ["Pin framework/core versions", "Lock @vanduo-oss/* versions so visual output is reproducible."],
  ["Ship only used CSS", "Import @vanduo-oss/framework/css once; avoid duplicating core CSS in vd2."],
...
<template>
  <DocsLayout>
    <section id="production-best-practices">
      ...
      <div class="vd-row vd-mb-6">
        <div class="vd-col-12 vd-col-md-6">
          <div class="vd-card demo-card">
            <div class="vd-card-header"><h6><i class="ph ph-hammer"></i> Build &amp; preview</h6></div>
        ...
        <div class="vd-col-12 vd-col-md-6">
          <div class="vd-card demo-card">
            <div class="vd-card-header"><h6><i class="ph ph-shield-check"></i> The verification gate</h6></div>
            <div class="vd-card-body">
      ...
      <div class="vd-card demo-card">
        <div class="vd-card-header"><h6><i class="ph ph-list-checks"></i> Production checklist</h6></div>
        <div class="vd-card-body">
