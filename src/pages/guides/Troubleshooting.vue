  ...
  <DocsLayout>
    <section id="troubleshooting">
      ...
      <div class="vd-card demo-card">
        <div class="vd-card-header"><h6><i class="ph ph-first-aid-kit"></i> Symptoms &amp; fixes</h6></div>
        <div class="vd-card-body">
          ...
          <p class="vd-text-sm vd-text-muted vd-mt-3">
            Still stuck? The <a href="/guides/runtime-architecture">Runtime
            architecture</a> and <a href="/guides/lifecycle-manager">Lifecycle</a>
