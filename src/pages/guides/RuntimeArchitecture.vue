...
const mapping: [string, string][] = [
  ...
  ["Vanduo.reinit(name, root)", "Reactive props / re-running the composable on a new root"],
  ["Vanduo.getComponent('toast')", "useToastStore() Pinia store (show / success / error)"],
  ["Global registry of components", "Per-feature composables + Pinia stores"],
  ["data-* attributes read by JS", "Same data-* attributes read by composables"],
];
</script>
  ...
  <DocsLayout>
    <section id="runtime-architecture">
      ...
      <p class="vd-mb-6">
        ...
        is reactive, tree-shakeable, and tied to component lifecycle.
      </p>
      ...
      <div class="vd-row vd-mb-6">
        ...
        <div class="vd-col-12 vd-col-md-6">
          <div class="vd-card demo-card">
            <div class="vd-card-header"><h6><i class="ph ph-atom"></i> vd2 composable</h6></div>
            <div class="vd-card-body">
      ...
      <div class="vd-row vd-mb-6">
        <div class="vd-col-12">
          <div class="vd-card demo-card">
            <div class="vd-card-header"><h6><i class="ph ph-arrows-left-right"></i> Mental-model mapping</h6></div>
            <div class="vd-card-body">
      ...
      <div class="vd-card demo-card">
        <div class="vd-card-header"><h6><i class="ph ph-plug"></i> Wiring a composable</h6></div>
        <div class="vd-card-body">
          <p>
