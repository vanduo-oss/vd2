...
const tactics: [string, string][] = [
  ...
  ["IntersectionObserver", "Activate effects (glass, parallax) only when scrolled into view."],
];
</script>
  ...
  <DocsLayout>
    <section id="lazy-loading">
      ...
      <div class="vd-row vd-mb-6">
        <div class="vd-col-12 vd-col-md-6">
          <div class="vd-card demo-card">
            <div class="vd-card-header"><h6><i class="ph ph-signpost"></i> Route-level code splitting</h6></div>
        ...
        <div class="vd-col-12 vd-col-md-6">
          <div class="vd-card demo-card">
            <div class="vd-card-header"><h6><i class="ph ph-cube"></i> Async components</h6></div>
            <div class="vd-card-body">
      ...
      <div class="vd-row vd-mb-6">
        <div class="vd-col-12">
          <div class="vd-card demo-card">
            <div class="vd-card-header"><h6><i class="ph ph-image"></i> Native lazy assets</h6></div>
            <div class="vd-card-body">
      ...
      <div class="vd-card demo-card">
        <div class="vd-card-header"><h6><i class="ph ph-list-checks"></i> Tactics at a glance</h6></div>
        <div class="vd-card-body">
          <div class="vd-table-responsive">
            <table class="vd-table vd-table-striped">
              <thead><tr><th>Tactic</th><th>What it does</th></tr></thead>
              <tbody>
