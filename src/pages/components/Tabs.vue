...
const tabsHtml = '<div class="vd-tabs"><button class="vd-tab is-active">A</button></div>';
</script>
  ...
  <DocsLayout>
    <VdStack gap="xl">
      <header>
        ...
        <p class="vd-lead">
          Switch between sibling views without leaving the page.
        </p>
      </header>
