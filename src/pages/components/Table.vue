...
import VdTable from '@/components/VdTable.vue';
...
const rows = [
  ...
  { name: 'Linus Torvalds', role: 'Maintainer', status: 'Active' },
];

const basicHtml = '<table class="vd-table">\n  <thead class="vd-table-header">\n    <tr><th>Name</th><th>Role</th></tr>\n  </thead>\n  <tbody>\n    <tr><td>Ada</td><td>Engineer</td></tr>\n  </tbody>\n</table>';
</script>
  ...
  <DocsLayout>
    <VdStack gap="xl">
      <header>
        ...
        <p class="vd-lead">
          Structured tabular data with optional striped, bordered, and
          hoverable variants.
        </p>
      </header>
