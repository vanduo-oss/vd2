...
<!-- Overlay on skeleton (preferred) -->
<div class="vd-dynamic-loader-card">
  <div class="vd-dynamic-loader">
    <div class="vd-dynamic-loader-grid">...</div>
        ...
        <div class="vd-col-12 vd-col-md-6">
          <div class="vd-card vd-card-glow demo-card">
            ...
            <div class="vd-card-body">
              ...
              <div class="vd-progress vd-mb-3">
                <div class="vd-progress-bar vd-progress-success" style="width: 65%"></div>
              </div>
              <p class="vd-text-sm vd-text-muted vd-mb-0">
          ...
          <div class="vd-card vd-card-glow demo-card">
            ...
            <div class="vd-card-body">
              <p class="vd-text-sm vd-text-muted vd-mb-3">
                ...
                semantic-colored spinners inside <code>.vd-dynamic-loader</code>.
                Staggered rotation comes from <code>spinner.css</code>
        ...
        <table class="vd-table vd-table-hover">
          ...
          <tbody>
            <tr>
              ...
              <td>
                <RouterLink to="/components/spinner">Spinners</RouterLink> — demos,
            ...
            <tr>
              <td><code>.vd-progress</code>, <code>.vd-progress-bar</code>, modifiers</td>
              <td><RouterLink to="/components/progress">Progress</RouterLink></td>
            </tr>
            <tr>
