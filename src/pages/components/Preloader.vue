...
const basicHtml =
  '<div class="vd-preloader-container">\n  <div class="vd-preloader vd-preloader-primary">\n    <div class="vd-preloader-spinner"></div>\n  </div>\n</div>';
</script>
...
<template>
  <DocsLayout>
    <VdStack gap="xl">
      <header>
        <h1 class="vd-h1">Preloader</h1>
        <p class="vd-lead">Page-level or section-level loading indicator.</p>
      </header>
      ...
      <section id="with-text" class="vd-stack vd-stack-md">
        <h2 class="vd-h2">With text</h2>
        <VdPreloader variant="primary" text="Loading…" />
      </section>
