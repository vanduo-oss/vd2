...
const customizerHtml =
  '<button class="vd-btn vd-btn-ghost" data-customizer-trigger>Customize</button>\n<div class="vd-theme-customizer" data-theme-customizer hidden>\n  ...sliders, color pickers, font selectors...\n</div>';
</script>
...
<template>
  <DocsLayout>
    <VdStack gap="xl">
      <header>
        <h1 class="vd-h1">Theme customizer</h1>
        <p class="vd-lead">
          Live-edit design tokens: colors, fonts, spacing, and radius. Persists
          to localStorage.
        </p>
      </header>
      ...
      <section id="demo" class="vd-stack vd-stack-md">
        ...
        <VdButton variant="primary" @click="open = true">
          Open customizer
        </VdButton>
      ...
      <section id="usage" class="vd-stack vd-stack-md">
        ...
        <VdCodeSnippet language="html" :code="customizerHtml" />
      </section>
    </VdStack>
  </DocsLayout>
</template>
