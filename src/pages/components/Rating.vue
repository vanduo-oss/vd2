...
const rating = ref(4);
const readonly = ref(3);

const ratingHtml = '<div class="vd-rating vd-rating-md">\n  <span class="vd-rating-star is-filled">★</span>\n</div>';
</script>
  ...
  <DocsLayout>
    <VdStack gap="xl">
      <header>
        ...
        <p class="vd-lead">
          Star rating input with hover preview and readonly mode.
        </p>
      </header>
