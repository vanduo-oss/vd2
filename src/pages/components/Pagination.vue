...
const jsMethods: [string, string][] = [
  ["VanduoPagination.init()", "Scans for all [data-pagination] elements and renders them"],
  ["VanduoPagination.goToPage(el, page)", "Activates the given page and fires pagination:change"],
  ["VanduoPagination.update(el, options)", "Updates totalPages / currentPage / maxVisible and re-renders"],
  ["VanduoPagination.destroy(el)", "Removes listeners from the given pagination element"],
];
...
<template>
  <DocsLayout>
    <section id="pagination">
      <h5 class="demo-title"><i class="ph ph-dots-three-outline"></i>Pagination</h5>
      <p class="vd-mb-5">
        ...
        <div class="vd-col-12">
          <div id="demo-pagination-basic" class="vd-card vd-card-glow demo-card">
            ...
            <div class="vd-card-body">
              ...
              <p class="vd-text-sm vd-text-muted vd-mt-3">Current page: {{ basicPage }}</p>
      ...
      <div class="vd-row">
        <div class="vd-col-12">
          <div id="demo-pagination-sizes" class="vd-card vd-card-glow demo-card">
            ...
            <div class="vd-card-body" style="display:flex; flex-direction:column; gap:1rem;">
      ...
      <div class="vd-row">
        <div class="vd-col-12 vd-col-md-6">
          <div id="demo-pagination-ellipsis" class="vd-card vd-card-glow demo-card">
            ...
            <div class="vd-card-body">
              ...
              <p class="vd-text-sm vd-text-muted vd-mt-3">Current page: {{ ellipsisPage }}</p>
        ...
        <!-- Disabled -->
        <div class="vd-col-12 vd-col-md-6">
          <div id="demo-pagination-disabled" class="vd-card vd-card-glow demo-card">
      ...
      <div class="vd-card vd-card-glow demo-card">
        ...
        <div class="vd-card-body">
          <ul>
            <li>The control is wrapped in <code>&lt;nav aria-label="Pagination"&gt;</code></li>
            <li>The active page link carries <code>aria-current="page"</code></li>
            <li>Each page link has a descriptive <code>aria-label</code> (e.g. <code>"Page 4"</code>)</li>
            <li>Ellipses use <code>aria-hidden="true"</code> so they are skipped by screen readers</li>
            <li>Previous / Next become <code>.disabled</code> (and non-interactive) at the range boundaries</li>
          </ul>
        </div>
      </div>
    </section>
