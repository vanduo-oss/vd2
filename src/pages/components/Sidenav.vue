...
<aside class="vd-sidenav" id="demo-sidenav">
        ...
        <div class="vd-col-12 vd-col-md-6">
          <div class="vd-card vd-card-glow demo-card">
            ...
            <div class="vd-card-body">
              <button class="vd-btn vd-btn-primary" data-sidenav-toggle="#demo-sidenav-inline">
                <i class="ph ph-sidebar"></i> Open Sidenav
              </button>
            </div>
          </div>
          <aside class="vd-sidenav" id="demo-sidenav-inline">
            <div class="vd-sidenav-header">
              <h3 class="vd-sidenav-title">Menu</h3>
              <button class="vd-sidenav-close" aria-label="Close">&times;</button>
            </div>
            <div class="vd-sidenav-body">
              <ul class="vd-sidenav-nav">
                <li class="vd-sidenav-item active">
                  <a class="vd-sidenav-link" href="#" @click.prevent><i class="ph ph-house"></i> Home</a>
                </li>
                <li class="vd-sidenav-item">
                  <a class="vd-sidenav-link" href="#" @click.prevent><i class="ph ph-user"></i> Profile</a>
                </li>
                <li class="vd-sidenav-item">
                  <a class="vd-sidenav-link" href="#" @click.prevent><i class="ph ph-gear"></i> Settings</a>
                </li>
              </ul>
            </div>
          </aside>
