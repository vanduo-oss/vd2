...
const cssClasses: [string, string][] = [
  ...
  [".vd-suggest-list", "The dropdown <code>&lt;ul&gt;</code> containing suggestion items"],
  [".vd-suggest-item", "Individual suggestion <code>&lt;li&gt;</code> inside the list"],
...
const jsMethods: [string, string][] = [
  ["VanduoSuggest.init()", "Scans the DOM for [data-vd-suggest] and [data-vd-autocomplete] inputs and wires them up"],
  ["VanduoSuggest.destroy(el)", "Removes event listeners, dropdown, and wrapper from the given input element"],
];
  ...
  <DocsLayout>
    <section id="autocomplete" ref="root">
            ...
            <div class="vd-card-body">
              <div class="vd-form-group">
                ...
                <div class="vd-suggest-wrapper">
                  <input type="text" id="suggest-fruits" class="vd-input" placeholder="Type a fruit name…" :data-vd-suggest="fruits" />
                </div>
              </div>
          ...
          <div id="demo-suggest-capitals" class="vd-card vd-card-glow demo-card">
            ...
            <div class="vd-card-body">
              <div class="vd-form-group">
                ...
                <div class="vd-suggest-wrapper">
                  <input type="text" id="suggest-cities" class="vd-input" placeholder="Type an EU capital…" :data-vd-suggest="capitals" />
                </div>
              </div>
      ...
      <div class="vd-row">
          ...
          <div id="demo-suggest-min-chars" class="vd-card vd-card-glow demo-card">
            ...
            <div class="vd-card-body">
              <div class="vd-form-group">
                ...
                <div class="vd-suggest-wrapper">
                  <input type="text" id="suggest-countries" class="vd-input" placeholder="Type at least 2 letters…" :data-vd-suggest="countries" data-vd-suggest-min-chars="2" />
                </div>
              </div>
        ...
        <div class="vd-col-12 vd-col-md-6">
          <div id="demo-suggest-alias" class="vd-card vd-card-glow demo-card">
            <div class="vd-card-header"><h6>Alias: <code>data-vd-autocomplete</code></h6></div>
            <div class="vd-card-body">
              <div class="vd-form-group">
                <label for="suggest-colors">Search Colors</label>
                <div class="vd-suggest-wrapper">
                  <input type="text" id="suggest-colors" class="vd-input" placeholder="Type a color…" :data-vd-autocomplete="colors" />
                </div>
              </div>
      ...
      <div class="vd-card vd-card-glow demo-card">
        ...
        <div class="vd-card-body">
          <ul>
            <li>The input receives <code>role="combobox"</code> and <code>aria-autocomplete="list"</code></li>
            <li>The suggestion list has <code>role="listbox"</code>; each item has <code>role="option"</code></li>
            <li><code>aria-expanded</code> toggles <code>true</code>/<code>false</code> as the dropdown opens and closes</li>
            <li><code>aria-activedescendant</code> tracks the currently highlighted option for screen readers</li>
            <li><kbd>↑</kbd> / <kbd>↓</kbd> arrow keys navigate the list; <kbd>Enter</kbd> selects; <kbd>Escape</kbd> closes</li>
            <li>Focus returns to the input after selection, preserving natural tab order</li>
          </ul>
        </div>
      </div>
    </section>
