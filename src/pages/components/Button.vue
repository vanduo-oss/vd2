...
const classRef: ClassRef[] = [
  { cls: ".vd-btn", desc: "Base button class — required on all buttons", type: "Base" },
  { cls: ".vd-btn-primary", desc: "Primary action color", type: "Variant" },
  { cls: ".vd-btn-secondary", desc: "Secondary/neutral action color", type: "Variant" },
  { cls: ".vd-btn-success", desc: "Success/positive action color", type: "Variant" },
  { cls: ".vd-btn-warning", desc: "Warning/caution action color", type: "Variant" },
  { cls: ".vd-btn-error", desc: "Error/destructive action color", type: "Variant" },
  { cls: ".vd-btn-info", desc: "Informational action color", type: "Variant" },
  { cls: ".vd-btn-outline", desc: "Outlined button (neutral border)", type: "Variant" },
  { cls: ".vd-btn-outline-primary", desc: "Outlined button with primary color", type: "Variant" },
  { cls: ".vd-btn-outline-secondary", desc: "Outlined button with secondary color", type: "Variant" },
  ...
  { cls: ".vd-btn-ghost", desc: "Transparent background with hover tint", type: "Variant" },
  { cls: ".vd-btn-ghost-primary … .vd-btn-ghost-subtle", desc: "Ghost with color-tinted hover states", type: "Variant" },
  { cls: ".vd-btn-icon", desc: "Circular icon-only button", type: "Modifier" },
  { cls: ".is-loading", desc: "Shows a spinner and disables clicks", type: "State (class)" },
  { cls: ".vd-btn-full", desc: "Full-width button (inline-block)", type: "Size" },
  { cls: "disabled", desc: "Disables interaction and dims button", type: "State (attr)" },
];
</script>
        ...
        <div class="vd-col-12">
          <div class="vd-card vd-card-glow demo-card">
            ...
            <div class="vd-card-body">
              ...
              <button class="vd-btn vd-btn-primary" aria-pressed="true">Active</button>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="vd-col-12">
          <div class="vd-card vd-card-glow demo-card">
            <div class="vd-card-header">
              <h6>
                <i class="ph ph-list-dashes mr-2" style="color: var(--vd-color-primary)"></i>Class
                Reference
              </h6>
            </div>
            <div class="vd-card-body">
