...
import DocSectionNav from "@/layout/DocSectionNav.vue";
...
<template>
  <DocsLayout>
    <template #default>
      <VdStack gap="xl">
        <header>
          <h1 class="vd-h1">Button</h1>
          <p class="vd-lead">
            Trigger actions with primary, secondary, ghost, or danger variants.
          </p>
        </header>
        <section id="examples" class="vd-stack vd-stack-md">
          <h2 class="vd-h2">Examples</h2>
          <div class="vd-inline vd-inline-md">
            <VdButton variant="primary"> Save </VdButton>
            <VdButton variant="secondary"> Cancel </VdButton>
            <VdButton variant="ghost"> Learn more </VdButton>
            <VdButton variant="danger"> Delete </VdButton>
          </div>
        </section>
