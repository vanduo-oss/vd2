...
const basicItems = [
  { title: "Accordion Item 1", body: "This is the content of the first accordion item." },
  { title: "Accordion Item 2", body: "This is the content of the second accordion item." },
  { title: "Accordion Item 3", body: "This is the content of the third accordion item." },
];
const flushItems = [
  { title: "Design Tokens", body: "Theme-aware colors, spacing, and typography are inherited from global tokens." },
  { title: "Accessibility", body: "Keyboard and focus interactions are handled by the framework component runtime." },
];
...
const apiRows: [string, string][] = [
  ...
  [".accordion-header", "Clickable trigger that expands or collapses item content."],
  ...
  [".accordion-flush", "Variant that removes per-item outer borders and spacing so rows stack with divider lines instead of separate cards."],
...
<template>
  <DocsLayout>
    <section id="accordion">
      <h5 class="demo-title"><i class="ph ph-list-plus"></i>Accordion / Collapsible</h5>
      <p class="vd-mb-8">
