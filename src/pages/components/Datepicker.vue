...
const cssClasses: [string, string][] = [
  ...
  [".vd-datepicker-grid", 'Wraps the weekday row and week rows (<code>role="grid"</code>)'],
  [".vd-datepicker-days", "Legacy 7-column grid class (week rows use <code>.vd-datepicker-row</code>)"],
...
const dataAttrs: [string, string][] = [
  ...
  ["data-vd-datepicker-format", 'Date format string. Tokens: <code>YYYY</code>, <code>MM</code>, <code>DD</code> (matched case-insensitively). Default: <code>"YYYY-MM-DD"</code>'],
  ["data-vd-datepicker-min", "Earliest selectable date in <code>YYYY-MM-DD</code> format"],
  ["data-vd-datepicker-max", "Latest selectable date in <code>YYYY-MM-DD</code> format"],
];

const jsMethods: [string, string][] = [
  ["VanduoDatepicker.init()", "Scans for all [data-vd-datepicker] inputs and attaches calendar popups"],
  ["VanduoDatepicker.destroy(el)", "Removes the calendar popup and event listeners from the given input"],
];

const events: [string, string][] = [
  ["datepicker:select", "Fired on the input when a date is picked. <code>event.detail</code> contains <code>{ date: Date, formatted: string }</code>"],
];
</script>
  ...
  <DocsLayout>
    <section id="datepicker" ref="root">
      ...
      <p class="vd-mb-5">
        ...
        to any text input. Supports custom date formats, min/max date
      ...
      <div class="vd-row">
            ...
            <div class="vd-card-body">
              ...
              <div class="vd-form-group">
                ...
                <div class="vd-suggest-wrapper">
                  <input type="text" id="dp-basic" class="vd-input" placeholder="YYYY-MM-DD" data-vd-datepicker readonly />
                </div>
              </div>
        ...
        <div class="vd-col-12 vd-col-md-6">
          <div id="demo-datepicker-preselect" class="vd-card vd-card-glow demo-card">
            <div class="vd-card-header"><h6>Pre-selected Value &amp; Custom Format</h6></div>
            <div class="vd-card-body">
              <p class="vd-text-sm vd-text-muted vd-mb-4">
              ...
              <div class="vd-form-group">
                ...
                <div class="vd-suggest-wrapper">
                  <input type="text" id="dp-preselect" class="vd-input" value="01/15/2026" data-vd-datepicker data-vd-datepicker-format="MM/DD/YYYY" readonly />
                </div>
              </div>
      ...
      <div class="vd-row">
        <div class="vd-col-12 vd-col-md-6">
          <div id="demo-datepicker-minmax" class="vd-card vd-card-glow demo-card">
            <div class="vd-card-header"><h6>Min / Max Date Constraints</h6></div>
            <div class="vd-card-body">
              <p class="vd-text-sm vd-text-muted vd-mb-4">
              ...
              <div class="vd-form-group">
                ...
                <div class="vd-suggest-wrapper">
                  <input type="text" id="dp-minmax" class="vd-input" placeholder="Pick a date…" data-vd-datepicker data-vd-datepicker-min="2026-05-01" data-vd-datepicker-max="2026-05-31" readonly />
                </div>
              </div>
        ...
        <div class="vd-col-12 vd-col-md-6">
          <div id="demo-datepicker-navigation" class="vd-card vd-card-glow demo-card">
            ...
            <div class="vd-card-body">
              ...
              <div class="vd-form-group">
                ...
                <div class="vd-suggest-wrapper">
                  <input type="text" id="dp-nav" class="vd-input" value="18.04.2026" placeholder="DD.MM.YYYY" data-vd-datepicker data-vd-datepicker-format="DD.MM.YYYY" readonly />
                </div>
              </div>
      ...
      <div class="vd-card vd-card-glow demo-card">
        ...
        <div class="vd-card-body">
          <ul>
            <li>The popup has <code>role="dialog"</code> and <code>aria-label="Choose date"</code></li>
            <li>Calendar uses <code>role="grid"</code>; weekday labels use <code>role="columnheader"</code>; in-month days use <code>role="gridcell"</code></li>
            <li><kbd>←</kbd> / <kbd>→</kbd> move by day; <kbd>↑</kbd> / <kbd>↓</kbd> move by week</li>
            <li><kbd>Home</kbd> / <kbd>End</kbd> jump to start/end of the current week</li>
            <li><kbd>Page Up</kbd> / <kbd>Page Down</kbd> navigate by month</li>
            <li><kbd>Enter</kbd> selects the focused date; <kbd>Escape</kbd> closes the popup and returns focus to the input</li>
            <li>Disabled dates have <code>aria-disabled="true"</code> and are skipped during keyboard navigation</li>
          </ul>
        </div>
      </div>
    </section>
