...
const html = '<div class="vd-btn-group">\n  <button class="vd-btn vd-btn-primary">Save</button>\n  <button class="vd-btn vd-btn-secondary">Cancel</button>\n</div>';
</script>
  ...
  <DocsLayout>
    <VdStack gap="xl">
      <header>
        ...
        <p class="vd-lead">
          Group related buttons into a single horizontal or vertical
          toolbar.
        </p>
      </header>
      ...
      >
        ...
        <VdButtonGroup>
          ...
          <VdButton variant="secondary">
            Cancel
          </VdButton>
          <VdButton variant="ghost">
            Help
          </VdButton>
        </VdButtonGroup>
      </section>
