...
const jsMethods: [string, string][] = [
  ["VanduoTimepicker.init()", "Scans for all [data-vd-timepicker] inputs and attaches time dropdowns"],
  ["VanduoTimepicker.destroy(el)", "Removes the time dropdown and event listeners from the given input"],
];
    ...
    <section id="timepicker" ref="root">
      ...
      <div class="vd-row" style="margin-bottom: var(--vd-grid-gutter);">
        <div class="vd-col-12 vd-col-md-4" style="display: flex;">
          <div id="demo-timepicker-12h" class="vd-card vd-card-glow demo-card" style="display: flex; flex-direction: column; height: 100%;">
            <div class="vd-card-header"><h6>12-Hour Format (Default)</h6></div>
            <div class="vd-card-body" style="display: flex; flex: 1; flex-direction: column;">
              <div class="vd-form-group" style="display: flex; align-items: center; gap: 1.25rem;">
                <label for="tp-12h">Meeting Time</label>
                <input type="text" id="tp-12h" class="vd-input" placeholder="hh:mm AM/PM" data-vd-timepicker readonly style="flex: 1;" />
              </div>
        ...
        <div class="vd-col-12 vd-col-md-4" style="display: flex;">
          <div id="demo-timepicker-24h" class="vd-card vd-card-glow demo-card" style="display: flex; flex-direction: column; height: 100%;">
            <div class="vd-card-header"><h6>24-Hour Format</h6></div>
            <div class="vd-card-body" style="display: flex; flex: 1; flex-direction: column;">
              <div class="vd-form-group" style="display: flex; align-items: center; gap: 1.25rem;">
                <label for="tp-24h">Departure Time</label>
                <input type="text" id="tp-24h" class="vd-input" placeholder="HH:mm" data-vd-timepicker data-vd-timepicker-format="24h" readonly style="flex: 1;" />
              </div>
              <div style="margin-top: auto;">
        ...
        <div class="vd-col-12 vd-col-md-4" style="display: flex;">
          <div id="demo-timepicker-step" class="vd-card vd-card-glow demo-card" style="display: flex; flex-direction: column; height: 100%;">
            <div class="vd-card-header"><h6>15-Minute Step</h6></div>
            <div class="vd-card-body" style="display: flex; flex: 1; flex-direction: column;">
              <div class="vd-form-group" style="display: flex; align-items: center; gap: 1.25rem;">
                <label for="tp-step">Appointment Slot</label>
                <input type="text" id="tp-step" class="vd-input" placeholder="Select time…" data-vd-timepicker data-vd-timepicker-step="15" readonly style="flex: 1;" />
              </div>
              <div style="margin-top: auto;">
      ...
      <div class="vd-card vd-card-glow demo-card">
        ...
        <div class="vd-card-body">
          <ul>
            <li>The dropdown has <code>role="listbox"</code>; each time slot has <code>role="option"</code></li>
            <li>The input receives <code>aria-haspopup="listbox"</code> and <code>aria-expanded</code> state</li>
            <li><kbd>↑</kbd> / <kbd>↓</kbd> arrow keys navigate time slots; <kbd>Enter</kbd> selects; <kbd>Escape</kbd> closes</li>
            <li><code>aria-activedescendant</code> tracks the focused time slot for screen readers</li>
