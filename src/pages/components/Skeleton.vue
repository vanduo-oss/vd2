  ...
  <DocsLayout>
    <section id="skeleton">
      ...
      <div class="vd-row vd-mb-6">
        <div class="vd-col-12 vd-col-md-6">
          <div class="vd-card vd-card-glow demo-card">
            ...
            <div class="vd-card-body">
              ...
              <div class="vd-skeleton vd-skeleton-text vd-skeleton-text-xs vd-mb-3"></div>
              <div class="vd-skeleton vd-skeleton-text vd-skeleton-text-sm vd-mb-3"></div>
              <div class="vd-skeleton vd-skeleton-text vd-mb-3"></div>
              <div class="vd-skeleton vd-skeleton-text vd-skeleton-text-lg vd-mb-3"></div>
              <div class="vd-skeleton vd-skeleton-text vd-skeleton-text-xl"></div>
            </div>
          </div>
        ...
        <div class="vd-col-12 vd-col-md-6">
          <div class="vd-card vd-card-glow demo-card">
            <div class="vd-card-header"><h6>Circles, Rectangles &amp; Form Elements</h6></div>
            <div class="vd-card-body">
              ...
              <div style="display: flex; gap: 1rem; align-items: flex-end; margin-bottom: 1.5rem">
                <div class="vd-skeleton vd-skeleton-rect vd-skeleton-rect-sm" style="width: 120px"></div>
                <div class="vd-skeleton vd-skeleton-rect" style="width: 120px"></div>
                <div class="vd-skeleton vd-skeleton-rect vd-skeleton-rect-lg" style="width: 120px"></div>
              </div>
              ...
              <div class="vd-skeleton vd-skeleton-button vd-skeleton-button-sm vd-mb-3"></div>
              <div class="vd-skeleton vd-skeleton-button vd-skeleton-button-lg"></div>
            </div>
          </div>
      ...
      <div class="vd-row vd-mb-6">
        <div class="vd-col-12 vd-col-md-6">
          <div class="vd-card vd-card-glow demo-card">
            <div class="vd-card-header"><h6>Composite: Card &amp; List</h6></div>
            <div class="vd-card-body">
              ...
              <div class="vd-skeleton vd-skeleton-card vd-mb-5">
                ...
                <div class="vd-skeleton vd-skeleton-text vd-mb-2"></div>
                <div class="vd-skeleton vd-skeleton-text" style="width: 80%"></div>
              </div>
              <p class="vd-text-sm vd-text-muted vd-mb-3">List placeholder</p>
              <div class="vd-skeleton vd-skeleton-list">
                <div v-for="w in ['70%', '60%', '80%']" :key="w" class="vd-skeleton-list-item">
                  <div class="vd-skeleton vd-skeleton-circle vd-skeleton-circle-sm"></div>
                  <div class="vd-skeleton-list-item-content">
                    <div class="vd-skeleton vd-skeleton-text vd-skeleton-text-sm vd-mb-2"></div>
                    <div class="vd-skeleton vd-skeleton-text" :style="{ width: w }"></div>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="vd-col-12 vd-col-md-6">
          <div class="vd-card vd-card-glow demo-card">
            <div class="vd-card-header"><h6>Grid &amp; Width Utilities</h6></div>
            <div class="vd-card-body">
              ...
              ></div>
              <p class="vd-text-sm vd-text-muted vd-mb-3 vd-mt-5">No animation (static)</p>
              <div class="vd-skeleton vd-skeleton-static vd-skeleton-text vd-mb-3"></div>
            ...
            <div class="vd-card-body">
              <ul>
                <li>
                  ...
                  <code>aria-live="polite"</code> region and replace them with real
                  content once loaded, so screen readers announce the change.
                </li>
                <li>
                  Use <code>aria-busy="true"</code> on the container while skeletons
                  are visible to indicate the region is updating.
                </li>
                <li>
                ...
                <li>
                  ...
                  takes more than a few seconds, show a progress indicator or retry
                  option.
                </li>
                <li>
