...
const people = [
  { initials: "JD", name: "John Doe", role: "Software Engineer", bg: "var(--vd-color-primary)", active: false },
  { initials: "JS", name: "Jane Smith", role: "Designer", bg: "var(--vd-color-success)", active: false },
  { initials: "MJ", name: "Mike Johnson", role: "Product Manager", bg: "var(--vd-color-warning)", active: true },
];
</script>
          ...
          <div class="vd-card vd-card-glow demo-card">
            ...
            <div class="vd-card-body" style="padding: 0">
              <ul class="vd-collection">
                ...
                >
                  <div class="vd-collection-avatar" :style="`background: ${p.bg}; ${avatarStyle}`">
                    {{ p.initials }}
                  </div>
                  <div class="vd-collection-content">
