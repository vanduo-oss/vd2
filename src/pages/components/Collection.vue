  ...
  <DocsLayout>
    <VdStack gap="xl">
      <header>
        ...
        <p class="vd-lead">
          Vertical list of items with optional header, hover state, and
          bordered variant.
        </p>
      </header>
