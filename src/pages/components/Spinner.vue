...
const flexRow = "display:flex; gap:1.5rem; align-items:center; flex-wrap:wrap; margin-bottom:1.5rem;";
</script>
      ...
      <div class="vd-row vd-mb-6">
          ...
          <div id="demo-spinner-border" class="vd-card vd-card-glow demo-card">
            ...
            <div class="vd-card-body">
              ...
              <div :style="flexRow">
                ...
                <div class="vd-spinner vd-spinner-error"></div>
                <div class="vd-spinner vd-spinner-info"></div>
                <div class="vd-spinner vd-spinner-light" style="background:var(--vd-color-gray-800);padding:4px;border-radius:4px;"></div>
                <div class="vd-spinner vd-spinner-dark"></div>
              </div>
              <p class="vd-text-sm vd-text-muted vd-mb-3">Inside buttons</p>
              <div style="display:flex; gap:.75rem; flex-wrap:wrap; margin-bottom:1.5rem;">
                <button class="vd-btn vd-btn-primary" disabled>
                  <span class="vd-spinner vd-spinner-sm" style="border-color:rgba(255,255,255,0.3);border-top-color:#fff;vertical-align:middle;margin-right:.5rem;"></span>
                  Loading...
                </button>
                <button class="vd-btn vd-btn-outline" disabled>
                  <span class="vd-spinner vd-spinner-sm" style="vertical-align:middle;margin-right:.5rem;"></span>
                  Saving
                </button>
              </div>
            </div>
        ...
        <div class="vd-col-12 vd-col-md-6">
          <div id="demo-spinner-dots-grow" class="vd-card vd-card-glow demo-card">
            <div class="vd-card-header"><h6>Dots &amp; Growing Spinner</h6></div>
            <div class="vd-card-body">
              <p class="vd-text-sm vd-text-muted vd-mb-3">Dot bounce</p>
              <div :style="flexRow">
                <div class="vd-spinner-dots"><span></span></div>
                <div class="vd-spinner-dots" style="--vd-spinner-color:var(--vd-color-success);"><span></span></div>
                <div class="vd-spinner-dots" style="--vd-spinner-color:var(--vd-color-error);"><span></span></div>
              </div>
              <p class="vd-text-sm vd-text-muted vd-mb-3">Growing pulse</p>
              <div :style="flexRow">
                <div class="vd-spinner-grow vd-spinner-sm"></div>
                <div class="vd-spinner-grow"></div>
                <div class="vd-spinner-grow vd-spinner-lg" style="--vd-spinner-color:var(--vd-color-success);"></div>
                <div class="vd-spinner-grow vd-spinner-xl" style="--vd-spinner-color:var(--vd-color-error);"></div>
              </div>
              <p class="vd-text-sm vd-text-muted vd-mb-3">Centering helper</p>
              <div class="vd-spinner-center vd-mb-0" style="border:1px dashed var(--vd-border-color); border-radius:var(--vd-btn-border-radius);">
                <div class="vd-spinner vd-spinner-lg"></div>
              </div>
            </div>
          </div>
      ...
      <div class="vd-row vd-mb-6">
        <div class="vd-col-12">
          <div id="demo-spinner-quad" class="vd-card vd-card-glow demo-card">
            <div class="vd-card-header"><h6>Quad Loader (Signature Vanduo Loader)</h6></div>
            <div class="vd-card-body">
              <p class="vd-text-sm vd-text-muted vd-mb-4">The grid applies staggered rotation via <code>.vd-dynamic-loader-grid</code> (nth-child delays in CSS). Optional inline <code>animation-delay</code> overrides are only needed if you want custom rhythm.</p>
              <div class="vd-dynamic-loader vd-mb-5">
                <div class="vd-dynamic-loader-grid">
                  <div class="vd-spinner vd-spinner-sm" style="--vd-spinner-color:var(--vd-color-primary);"></div>
                  <div class="vd-spinner vd-spinner-sm" style="--vd-spinner-color:var(--vd-color-secondary);"></div>
                  <div class="vd-spinner vd-spinner-sm" style="--vd-spinner-color:var(--vd-color-success);"></div>
                  <div class="vd-spinner vd-spinner-sm" style="--vd-spinner-color:var(--vd-color-warning);"></div>
                </div>
                <div class="vd-dynamic-loader-text">Loading your workspace...</div>
              </div>
              <p class="vd-text-sm vd-text-muted vd-mb-3">Overlay on a skeleton card</p>
      ...
      <div class="vd-row vd-mb-6">
        <div class="vd-col-12">
          <div class="vd-card vd-card-glow demo-card">
            ...
            <div class="vd-card-body">
              <ul>
                <li>Always include an <code>aria-label</code> or visually-hidden text describing the loading state: <code>&lt;div class="vd-spinner" aria-label="Loading..."&gt;&lt;/div&gt;</code>.</li>
                <li>When used inside buttons, the button itself should have <code>aria-disabled="true"</code> or <code>disabled</code> to prevent repeated submissions.</li>
                <li>For page-level loading (quad loader), wrap it in an element with <code>role="status"</code> and <code>aria-live="polite"</code> so screen readers announce the loading state.</li>
                <li>Spinners are decorative for sighted users but meaningful for screen reader users — never omit the accessible name.</li>
                <li>Animations slow down to 1.5s when <code>prefers-reduced-motion: reduce</code> is active to minimize vestibular discomfort.</li>
              </ul>
            </div>
          </div>
        </div>
