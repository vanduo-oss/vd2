...
const dataAttrs: [string, string, string][] = [
  ...
  ["data-vd-loop", 'Loop back to start after last slide when set to "true"', "false"],
];

const jsMethods: [string, string][] = [
  ["VanduoFlow.init()", "Initialize all .vd-flow components on the page"],
  ["VanduoFlow.next(el)", "Advance the given carousel element to the next slide"],
  ["VanduoFlow.prev(el)", "Move the given carousel element to the previous slide"],
  ["VanduoFlow.goTo(el, index)", "Jump the given carousel to the slide at index (0-based)"],
  ["VanduoFlow.destroy(el)", "Tear down event listeners and timers for the given carousel"],
];
</script>
          ...
          <div id="demo-flow-basic" class="vd-card vd-card-glow demo-card">
            ...
            <div class="vd-card-body">
              <div class="vd-flow" data-vd-loop="true">
                <div class="vd-flow-track">
                  <div class="vd-flow-slide" style="background: linear-gradient(135deg, var(--vd-color-primary), var(--vd-color-info)); color: #fff; padding: 3rem; text-align: center; border-radius: var(--vd-radius-fib-5);">
                    <h4 style="margin: 0 0 0.5rem;">Slide One</h4>
                    <p style="margin: 0; opacity: 0.85;">Horizontal slide transition</p>
                  </div>
                  <div class="vd-flow-slide" style="background: linear-gradient(135deg, var(--vd-color-success), var(--vd-color-primary)); color: #fff; padding: 3rem; text-align: center; border-radius: var(--vd-radius-fib-5);">
                    <h4 style="margin: 0 0 0.5rem;">Slide Two</h4>
                    <p style="margin: 0; opacity: 0.85;">Swipe or use controls to navigate</p>
                  </div>
                  <div class="vd-flow-slide" style="background: linear-gradient(135deg, var(--vd-color-warning), var(--vd-color-error)); color: #fff; padding: 3rem; text-align: center; border-radius: var(--vd-radius-fib-5);">
                    <h4 style="margin: 0 0 0.5rem;">Slide Three</h4>
                    <p style="margin: 0; opacity: 0.85;">Fully responsive and accessible</p>
                  </div>
                </div>
                <button class="vd-flow-prev" aria-label="Previous slide"><i class="ph ph-caret-left"></i></button>
                <button class="vd-flow-next" aria-label="Next slide"><i class="ph ph-caret-right"></i></button>
              </div>
            </div>
          </div>
      ...
      <div class="vd-row">
          ...
          <div id="demo-flow-fade" class="vd-card vd-card-glow demo-card">
            ...
            <div class="vd-card-body">
              <div class="vd-flow vd-flow-fade" data-vd-loop="true">
                <div class="vd-flow-track">
                  <div class="vd-flow-slide" style="background: linear-gradient(135deg, #667eea, #764ba2); color: #fff; padding: 3rem; text-align: center; border-radius: var(--vd-radius-fib-5);">
                    <h4 style="margin: 0;">Cross-fade transition</h4>
                  </div>
                  <div class="vd-flow-slide" style="background: linear-gradient(135deg, #f093fb, #f5576c); color: #fff; padding: 3rem; text-align: center; border-radius: var(--vd-radius-fib-5);">
                    <h4 style="margin: 0;">Smooth opacity blend</h4>
                  </div>
                  <div class="vd-flow-slide" style="background: linear-gradient(135deg, #4facfe, #00f2fe); color: #fff; padding: 3rem; text-align: center; border-radius: var(--vd-radius-fib-5);">
        ...
        <div class="vd-col-12 vd-col-md-6">
          <div id="demo-flow-autoplay" class="vd-card vd-card-glow demo-card">
            ...
            <div class="vd-card-body">
              <div class="vd-flow" data-vd-autoplay="true" data-vd-interval="4000" data-vd-loop="true">
                <div class="vd-flow-track">
                  <div class="vd-flow-slide" style="background: linear-gradient(135deg, #0c3483, #a2b6df); color: #fff; padding: 3rem; text-align: center; border-radius: var(--vd-radius-fib-5);">
                    <h4 style="margin: 0;">Auto-advances every 4s</h4>
                  </div>
                  <div class="vd-flow-slide" style="background: linear-gradient(135deg, #fc5c7d, #6a82fb); color: #fff; padding: 3rem; text-align: center; border-radius: var(--vd-radius-fib-5);">
                    <h4 style="margin: 0;">Pauses on hover</h4>
                  </div>
                  <div class="vd-flow-slide" style="background: linear-gradient(135deg, #11998e, #38ef7d); color: #fff; padding: 3rem; text-align: center; border-radius: var(--vd-radius-fib-5);">
          ...
          <div id="demo-flow-compact" class="vd-card vd-card-glow demo-card">
            ...
            <div class="vd-card-body">
              <div class="vd-flow vd-flow-compact" data-vd-loop="true">
                <div class="vd-flow-track">
                  <div class="vd-flow-slide" style="background: var(--vd-bg-secondary); padding: 1.5rem; text-align: center; border-radius: var(--vd-radius-fib-5);">
          ...
          <div id="demo-flow-lg" class="vd-card vd-card-glow demo-card">
            ...
            <div class="vd-card-body">
              <div class="vd-flow vd-flow-lg" data-vd-loop="true">
                <div class="vd-flow-track">
                  <div class="vd-flow-slide" style="background: linear-gradient(135deg, #232526, #414345); color: #fff; padding: 4rem; text-align: center; border-radius: var(--vd-radius-fib-5);">
                    <h4 style="margin: 0 0 0.5rem;">Hero-size Carousel</h4>
                    <p style="margin: 0; opacity: 0.8;">Great for feature showcases and landing pages</p>
                  </div>
                  <div class="vd-flow-slide" style="background: linear-gradient(135deg, #1a2a6c, #b21f1f); color: #fff; padding: 4rem; text-align: center; border-radius: var(--vd-radius-fib-5);">
                    <h4 style="margin: 0 0 0.5rem;">Full-width Content</h4>
                    <p style="margin: 0; opacity: 0.8;">Increased padding and height for impact</p>
                  </div>
                </div>
                <button class="vd-flow-prev" aria-label="Previous slide"><i class="ph ph-caret-left"></i></button>
                <button class="vd-flow-next" aria-label="Next slide"><i class="ph ph-caret-right"></i></button>
            ...
            <table class="vd-table vd-table-striped">
              ...
              <tbody>
                <tr>
                  ...
                  <td>Fired on the <code>.vd-flow</code> element after a slide transition completes</td>
      ...
      <div class="vd-card vd-card-glow demo-card">
        ...
        <div class="vd-card-body">
          <ul>
            ...
            <li>Indicator buttons use <code>aria-label="Go to slide N"</code> for identification</li>
            <li>Active indicator receives <code>aria-current="true"</code> and <code>.is-active</code> class</li>
            <li>Autoplay pauses on <code>:hover</code> and <code>:focus-within</code> to respect user interaction</li>
            <li>Keyboard navigation: <kbd>ArrowLeft</kbd> / <kbd>ArrowRight</kbd> move between slides when focused</li>
            <li>The carousel container uses <code>role="region"</code> and <code>aria-roledescription="carousel"</code></li>
            <li>Each slide uses <code>role="group"</code> and <code>aria-roledescription="slide"</code></li>
          </ul>
        </div>
      </div>
    </section>
