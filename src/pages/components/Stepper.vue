...
const jsMethods: [string, string][] = [
  ["VanduoStepper.init()", "Initializes all stepper instances in the DOM. Call after dynamic content loads."],
  ["VanduoStepper.setStep(el, index)", "Sets the active step to the given zero-based index. Previous steps are marked completed."],
  ["VanduoStepper.next(el)", "Advances to the next step. Marks the current step as completed."],
  ["VanduoStepper.prev(el)", "Returns to the previous step. Reverts the current step to pending."],
  ["VanduoStepper.destroy(el)", "Removes event listeners and internal state for the given stepper element."],
];
  ...
  <DocsLayout>
    <section id="stepper" ref="root">
      ...
      <div class="vd-row vd-mb-6">
        <div class="vd-col-12">
          <div id="demo-stepper-horizontal" class="vd-card vd-card-glow demo-card">
            ...
            <div class="vd-card-body">
              <div id="stepper-h-demo" class="vd-stepper" role="list">
                <div class="vd-stepper-item is-completed" role="listitem">
                  <div class="vd-stepper-circle"><i class="ph ph-check"></i></div>
                  <div class="vd-stepper-label">Account
                    <span class="vd-stepper-description">Create your credentials</span>
                  </div>
                </div>
                <div class="vd-stepper-item is-completed" role="listitem">
                  <div class="vd-stepper-circle"><i class="ph ph-check"></i></div>
                  <div class="vd-stepper-label">Profile
                    <span class="vd-stepper-description">Personal information</span>
                  </div>
                </div>
                <div class="vd-stepper-item is-active" role="listitem">
                  <div class="vd-stepper-circle">3</div>
                  <div class="vd-stepper-label">Preferences
                    <span class="vd-stepper-description">Customize your experience</span>
                  </div>
                </div>
                <div class="vd-stepper-item" role="listitem">
                  <div class="vd-stepper-circle">4</div>
                  <div class="vd-stepper-label">Confirmation
                    <span class="vd-stepper-description">Review &amp; submit</span>
                  </div>
                </div>
              </div>
              <div style="display:flex;gap:.5rem;justify-content:center;margin-top:1.5rem;">
                <button class="vd-btn vd-btn-outline vd-btn-sm" data-stepper-demo-control="prev" data-stepper-target="#stepper-h-demo">
                  <i class="ph ph-caret-left"></i> Previous
                </button>
                <button class="vd-btn vd-btn-primary vd-btn-sm" data-stepper-demo-control="next" data-stepper-target="#stepper-h-demo">
      ...
      <div class="vd-row vd-mb-6">
          ...
          <div id="demo-stepper-vertical" class="vd-card vd-card-glow demo-card">
            ...
            <div class="vd-card-body">
              <div class="vd-stepper vd-stepper-vertical" role="list">
                <div class="vd-stepper-item is-completed" role="listitem">
                  <div class="vd-stepper-circle"><i class="ph ph-check"></i></div>
                  <div class="vd-stepper-label">Order Placed
                    <span class="vd-stepper-description">Your order has been confirmed</span>
                  </div>
                </div>
                <div class="vd-stepper-item is-active" role="listitem">
                  <div class="vd-stepper-circle">2</div>
                  <div class="vd-stepper-label">Processing
                    <span class="vd-stepper-description">We're preparing your items</span>
                  </div>
                </div>
                <div class="vd-stepper-item" role="listitem">
                  <div class="vd-stepper-circle">3</div>
                  <div class="vd-stepper-label">Shipped
                    <span class="vd-stepper-description">On the way to your address</span>
                  </div>
                </div>
                <div class="vd-stepper-item" role="listitem">
                  <div class="vd-stepper-circle">4</div>
                  <div class="vd-stepper-label">Delivered
        ...
        <div class="vd-col-12 vd-col-md-6">
          <div id="demo-stepper-clickable" class="vd-card vd-card-glow demo-card">
            ...
            <div class="vd-card-body">
              <div id="stepper-click-demo" class="vd-stepper vd-stepper-clickable" role="list">
                <div class="vd-stepper-item is-completed" role="listitem" tabindex="0">
                  <div class="vd-stepper-circle"><i class="ph ph-check"></i></div>
                  <div class="vd-stepper-label">Plan
                    <span class="vd-stepper-description">Choose a subscription</span>
                  </div>
                </div>
                <div class="vd-stepper-item is-active" role="listitem" tabindex="0">
                  <div class="vd-stepper-circle">2</div>
                  <div class="vd-stepper-label">Billing
                    <span class="vd-stepper-description">Payment details</span>
                  </div>
                </div>
                <div class="vd-stepper-item is-error" role="listitem" tabindex="0">
                  <div class="vd-stepper-circle"><i class="ph ph-warning"></i></div>
                  <div class="vd-stepper-label">Verification
                    <span class="vd-stepper-description">Identity check failed</span>
                  </div>
                </div>
              </div>
      ...
      <div class="vd-row">
        <div class="vd-col-12">
          <div class="vd-card vd-card-glow demo-card">
            ...
            <div class="vd-card-body">
              <ul>
                <li>The stepper container uses <code>role="list"</code> and each step uses <code>role="listitem"</code> for assistive technology.</li>
                <li>Active step is announced via <code>aria-current="step"</code>.</li>
                <li>Completed steps convey state through <code>aria-label="Completed"</code> on the circle.</li>
                <li>Error steps include <code>aria-label="Error"</code> for screen reader feedback.</li>
                <li>Clickable steppers add <code>tabindex="0"</code> and respond to <kbd>Enter</kbd> and <kbd>Space</kbd> key presses.</li>
                <li>Focus order follows the visual step sequence from first to last.</li>
              </ul>
            </div>
          </div>
        </div>
