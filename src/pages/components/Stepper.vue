...
const items = [
  ...
  { id: 2, label: 'Shipping', description: 'Address & method' },
  { id: 3, label: 'Payment', description: 'Billing details' },
  { id: 4, label: 'Review', description: 'Confirm order' },
];
const current = ref(2);

const stepperHtml = '<ol class="vd-stepper">\n  <li class="vd-stepper-item is-current">...</li>\n</ol>';
</script>
  ...
  <DocsLayout>
    <VdStack gap="xl">
      <header>
        ...
        <p class="vd-lead">
          Multi-step process indicator with current/complete/pending
          states.
        </p>
      </header>
      ...
      >
        ...
        <div style="max-width: 400px;">
          <VdStepper
            ...
            vertical
            clickable
            @item-click="(id) => (current = id as number)"
          />
        </div>
      </section>
