...
const dataAttrs: [string, string][] = [
  ['data-tooltip="text"', "Plain text content for the tooltip. Auto-initialized by Vanduo.init()."],
...
const jsMethods: [string, string][] = [
  ["VanduoTooltips.init()", "Scans for [data-tooltip] and [data-tooltip-html] elements and wires hover events."],
  ["VanduoTooltips.show(el)", "Programmatically show a tooltip for an initialized element."],
  ["VanduoTooltips.hide(el)", "Hide the tooltip currently attached to the element."],
      ...
      <div class="vd-row vd-mb-6">
        <div class="vd-col-12 vd-col-md-6">
          <div class="vd-card vd-card-glow demo-card">
            ...
            <div
              class="vd-card-body"
              style="display: flex; gap: 1rem; flex-wrap: wrap; align-items: center; justify-content: center; min-height: 120px"
            >
              <button class="vd-btn vd-btn-outline" data-tooltip="Tooltip on top" data-tooltip-placement="top">Top</button>
              <button class="vd-btn vd-btn-outline" data-tooltip="Tooltip on bottom" data-tooltip-placement="bottom">Bottom</button>
              <button class="vd-btn vd-btn-outline" data-tooltip="Tooltip on left" data-tooltip-placement="left">Left</button>
              <button class="vd-btn vd-btn-outline" data-tooltip="Tooltip on right" data-tooltip-placement="right">Right</button>
            </div>
          </div>
        ...
        <div class="vd-col-12 vd-col-md-6">
          <div class="vd-card vd-card-glow demo-card">
            ...
            <div
              ...
              style="display: flex; gap: 1rem; flex-wrap: wrap; align-items: center; justify-content: center; min-height: 120px"
            >
              <button class="vd-btn vd-btn-primary" data-tooltip="Default tooltip">Default</button>
              <button class="vd-btn vd-btn-outline" data-tooltip="Dark tooltip" data-tooltip-variant="dark">Dark</button>
              <button class="vd-btn vd-btn-outline" data-tooltip="Light tooltip" data-tooltip-variant="light">Light</button>
              <button class="vd-btn vd-btn-outline" data-tooltip="Glass tooltip with backdrop blur" data-tooltip-variant="glass">Glass</button>
            </div>
            <div
              class="vd-card-body"
              style="display: flex; gap: 1rem; flex-wrap: wrap; align-items: center; justify-content: center; border-top: 1px solid var(--vd-border-color)"
            >
              <button class="vd-btn vd-btn-sm vd-btn-outline" data-tooltip="Small tooltip" data-tooltip-size="sm">Small</button>
              <button class="vd-btn vd-btn-outline" data-tooltip="Default tooltip">Default</button>
              <button class="vd-btn vd-btn-lg vd-btn-outline" data-tooltip="Large tooltip with more padding" data-tooltip-size="lg">Large</button>
            </div>
          </div>
