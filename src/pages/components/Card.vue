...
const classRef: [string, string, string][] = [
  ...
  [".vd-card-actionable", "Hover lift + cursor pointer + focus ring for clickable cards", "Modifier"],
...
<template>
  <DocsLayout>
    <section id="cards">
      ...
      <div class="vd-row vd-mb-10">
        <div class="vd-col-12 vd-col-md-4">
          <div class="vd-card vd-card-elevated demo-card">
            ...
            <div class="vd-card-body">
              <p>Default elevated surface — compare the shadow to outlined and filled.</p>
            </div>
            <div class="vd-card-footer">
              <button type="button" class="vd-btn vd-btn-primary vd-btn-sm">Action</button>
            </div>
          </div>
        </div>
        <div class="vd-col-12 vd-col-md-4">
          <div class="vd-card vd-card-outlined demo-card">
            ...
            <div class="vd-card-footer">
              <button type="button" class="vd-btn vd-btn-outline vd-btn-sm">Action</button>
            </div>
          </div>
        </div>
        <div class="vd-col-12 vd-col-md-4">
      ...
      <!-- Glass -->
      <h5 class="vd-mb-3"><i class="ph ph-drop-half-bottom mr-1"></i>Glass (frosted)</h5>
      <p class="vd-text-sm vd-text-muted vd-mb-4">
      ...
      <!-- Density -->
      <h5 class="vd-mb-3">
        <i class="ph ph-arrows-out-line-horizontal mr-1"></i>Compact &amp; spacious
      </h5>
      <div class="vd-row vd-mb-10">
        <div class="vd-col-12 vd-col-md-6">
      ...
      <!-- Actionable Cards -->
      <h5 class="vd-mb-3"><i class="ph ph-hand-pointing mr-1"></i>Actionable Cards</h5>
      <p class="vd-text-sm vd-text-muted vd-mb-4">
      ...
      <div class="vd-row vd-mb-10">
        <div class="vd-col-12 vd-col-md-6 vd-col-lg-4">
          <div class="vd-card vd-card-actionable vd-card-glow" role="button" tabindex="0">
            <div class="vd-card-body">
              <i
                class="ph ph-rocket-launch"
                style="font-size: 2rem; color: var(--vd-color-primary); margin-bottom: 0.75rem; display: block"
              ></i>
              <h5>Get Started</h5>
              <p class="vd-text-sm vd-text-muted vd-mb-0">
            ...
            <div class="vd-card-body">
              <div class="vd-table-responsive">
                <table class="vd-table vd-table-hover">
                  <thead>
                    <tr><th>Class</th><th>Description</th><th>Type</th></tr>
                  </thead>
                  <tbody>
