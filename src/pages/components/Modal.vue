  ...
  <DocsLayout>
    <VdStack gap="xl">
      <header>
        ...
        <p class="vd-lead">
          Dialog overlays with backdrop, focus trap, and Escape to close.
        </p>
      </header>
