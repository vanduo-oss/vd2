  ...
  <section id="menu">
    ...
    <div class="vd-row">
      <div class="vd-col-12 vd-col-md-6">
        <div id="demo-menu-basic" class="vd-card vd-card-glow demo-card">
      ...
      <div class="vd-col-12 vd-col-md-6">
        <div id="demo-menu-end" class="vd-card vd-card-glow demo-card">
    ...
    <div class="vd-row">
      <div class="vd-col-12 vd-col-md-6">
        <div id="demo-menu-links" class="vd-card vd-card-glow demo-card">
