...
const basicTree: TreeNode[] = [
  { id: "src", label: "src", icon: "ph ph-folder", children: [
    { id: "components", label: "components", icon: "ph ph-folder", children: [
    ...
    { id: "utils", label: "utils", icon: "ph ph-folder", children: [
  ...
  { id: "public", label: "public", icon: "ph ph-folder", children: [
...
const checkboxTree: TreeNode[] = [
  { id: "permissions", label: "Permissions", children: [
    { id: "users", label: "User Management", children: [
      { id: "users-read", label: "View Users" },
      { id: "users-create", label: "Create Users" },
      { id: "users-edit", label: "Edit Users" },
      { id: "users-delete", label: "Delete Users" },
    ]},
    { id: "content", label: "Content Management", children: [
    ...
    { id: "settings", label: "System Settings", children: [
...
const openTree: TreeNode[] = [
  { id: "docs", label: "Documentation", open: true, children: [
    { id: "getting-started", label: "Getting Started", open: true, children: [
      { id: "install", label: "Installation" },
      { id: "quick-start", label: "Quick Start Guide" },
      { id: "config", label: "Configuration" },
    ]},
    { id: "api-ref", label: "API Reference", children: [
...
const cssClasses: [string, string][] = [
  ...
  [".vd-tree-checkbox", "Checkbox input rendered when data-vd-tree-checkbox is set"],
...
const dataAttrs: [string, string][] = [
  ["data-vd-tree", "JSON array of tree nodes. Each node: { id, label, icon?, open?, children? }"],
  ["data-vd-tree-checkbox", "Renders checkboxes next to each node label"],
  ["data-vd-tree-cascade", "When combined with data-vd-tree-checkbox, checking a parent auto-checks all descendants, and vice-versa"],
];
...
const jsMethods: [string, string][] = [
  ["VanduoTree.init()", "Scans for all [data-vd-tree] elements and renders tree widgets"],
  ["VanduoTree.getChecked(el)", "Returns an array of id strings for all checked nodes (checkbox trees only)"],
  ["VanduoTree.destroy(el)", "Removes the rendered tree and event listeners from the element"],
];
  ...
  <DocsLayout>
    <section id="tree-view">
      ...
      <p class="vd-mb-5">
        ...
        expandable/collapsible tree. Supports checkbox selection with
      ...
      <div class="vd-row">
        ...
        <div class="vd-col-12 vd-col-md-6">
          <div id="demo-tree-checkbox" class="vd-card vd-card-glow demo-card">
            <div class="vd-card-header"><h6>Checkbox Tree with Cascade</h6></div>
            <div class="vd-card-body">
      ...
      <div class="vd-card vd-card-glow demo-card">
        ...
        <div class="vd-card-body">
          <ul>
            <li>The root container has <code>role="tree"</code>; each node has <code>role="treeitem"</code></li>
            <li>Child groups are wrapped in <code>role="group"</code></li>
            <li>Branch nodes set <code>aria-expanded="true"</code> or <code>"false"</code> to reflect open state</li>
            <li><kbd>↑</kbd> / <kbd>↓</kbd> navigate between visible nodes; <kbd>→</kbd> expands a branch; <kbd>←</kbd> collapses it</li>
            <li><kbd>Home</kbd> jumps to the first node; <kbd>End</kbd> jumps to the last visible node</li>
            <li><kbd>Space</kbd> toggles the checkbox on checkbox trees</li>
            <li><kbd>Enter</kbd> activates (selects/expands) the focused node</li>
            <li>Type-ahead: pressing a letter key jumps to the next node whose label starts with that character</li>
          </ul>
        </div>
      </div>
    </section>
