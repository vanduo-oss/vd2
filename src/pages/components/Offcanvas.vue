  ...
  <DocsLayout>
    <section id="offcanvas" ref="root">
      ...
      <div class="vd-row">
        <div class="vd-col-12 vd-col-md-6">
          <div id="demo-offcanvas-left" class="vd-card vd-card-glow demo-card">
            ...
            <div class="vd-card-body" style="display:flex; gap:1rem; flex-wrap:wrap; align-items:center;">
              <button class="vd-btn vd-btn-primary" data-sidenav-toggle="#offcanvas-left-demo">
          ...
          <aside class="vd-offcanvas" id="offcanvas-left-demo">
            ...
            <div class="vd-sidenav-body"><p>Default offcanvas slides in from the left edge.</p></div>
          </aside>
        </div>
        ...
        <div class="vd-col-12 vd-col-md-6">
          <div id="demo-offcanvas-right" class="vd-card vd-card-glow demo-card">
            ...
            <div class="vd-card-body" style="display:flex; gap:1rem; flex-wrap:wrap; align-items:center;">
              <button class="vd-btn vd-btn-primary" data-sidenav-toggle="#offcanvas-right-demo">
                Open Right<i class="ph ph-arrow-line-right ml-2"></i>
              </button>
            </div>
          </div>
          <aside class="vd-offcanvas vd-offcanvas-right" id="offcanvas-right-demo" data-vd-position="right">
            <div class="vd-sidenav-header">
              <h4 class="vd-sidenav-title">Right Panel</h4>
              <button class="vd-sidenav-close" aria-label="Close">&times;</button>
            </div>
            <div class="vd-sidenav-body"><p>Add <code>.vd-offcanvas-right</code> or <code>data-vd-position="right"</code>.</p></div>
          </aside>
        </div>
      </div>
      ...
      <div class="vd-row">
        <div class="vd-col-12 vd-col-md-6">
          <div id="demo-offcanvas-top" class="vd-card vd-card-glow demo-card">
            ...
            <div class="vd-card-body" style="display:flex; gap:1rem; flex-wrap:wrap; align-items:center;">
              <button class="vd-btn vd-btn-outline-primary" data-sidenav-toggle="#offcanvas-top-demo">
                <i class="ph ph-arrow-line-up mr-2"></i>Open Top
              </button>
            </div>
          </div>
          <aside class="vd-offcanvas vd-offcanvas-top vd-sidenav-top" id="offcanvas-top-demo" data-vd-position="top">
            <div class="vd-sidenav-header">
              <h4 class="vd-sidenav-title">Top Panel</h4>
              <button class="vd-sidenav-close" aria-label="Close">&times;</button>
            </div>
            <div class="vd-sidenav-body"><p>Full-width panel sliding down from the top edge — great for search overlays or notification trays.</p></div>
          </aside>
        ...
        <div class="vd-col-12 vd-col-md-6">
          <div id="demo-offcanvas-bottom" class="vd-card vd-card-glow demo-card">
            ...
            <div class="vd-card-body" style="display:flex; gap:1rem; flex-wrap:wrap; align-items:center;">
              <button class="vd-btn vd-btn-outline-primary" data-sidenav-toggle="#offcanvas-bottom-demo">
                <i class="ph ph-arrow-line-down mr-2"></i>Open Bottom
              </button>
            </div>
          </div>
          <aside class="vd-offcanvas vd-offcanvas-bottom vd-sidenav-bottom" id="offcanvas-bottom-demo" data-vd-position="bottom">
            <div class="vd-sidenav-header">
              <h4 class="vd-sidenav-title">Bottom Panel</h4>
              <button class="vd-sidenav-close" aria-label="Close">&times;</button>
            </div>
            <div class="vd-sidenav-body"><p>Full-width panel sliding up from the bottom — ideal for mobile action sheets.</p></div>
          </aside>
      ...
      <div class="vd-row">
        <div class="vd-col-12">
          <div id="demo-offcanvas-data" class="vd-card vd-card-glow demo-card">
            <div class="vd-card-header"><h6>Using <code>data-vd-position</code></h6></div>
            <div class="vd-card-body">
              <p class="vd-mb-4">You can set the slide direction entirely through the <code>data-vd-position</code> attribute instead of adding directional CSS classes. The JS reads this attribute at init time and applies the correct transform.</p>
      ...
      <div class="vd-card vd-card-glow demo-card">
        ...
        <div class="vd-card-body">
          <ul>
            <li>Offcanvas uses <code>role="dialog"</code> and <code>aria-modal="true"</code> when open</li>
            <li>Close button includes <code>aria-label="Close"</code> for assistive technology</li>
            <li>Focus is trapped within the panel while open and returned to the trigger on close</li>
            <li>Pressing <kbd>Escape</kbd> closes the offcanvas panel</li>
            <li>Overlay backdrop blocks interaction with the page beneath</li>
            <li>The trigger button uses <code>aria-expanded</code> reflecting open/closed state</li>
          </ul>
        </div>
      </div>
    </section>
