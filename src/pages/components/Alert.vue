  ...
  <DocsLayout>
    <section id="alerts">
      ...
      <div class="vd-row vd-mb-6">
          ...
          <div class="vd-card vd-card-glow demo-card">
            ...
            <div class="vd-card-body">
              <div class="vd-alert vd-alert-primary vd-mb-3">
                <i class="ph ph-info"></i>
                <div><strong>Primary.</strong> A general informational message for the user.</div>
              </div>
              ...
              <div class="vd-alert vd-alert-warning vd-mb-3">
                <i class="ph ph-warning"></i>
                <div><strong>Warning.</strong> Your subscription expires in 3 days.</div>
              </div>
              <div class="vd-alert vd-alert-error vd-mb-3">
                <i class="ph ph-x-circle"></i>
                <div><strong>Error.</strong> Unable to connect to the server. Please try again.</div>
              </div>
              <div class="vd-alert vd-alert-info vd-mb-0">
                <i class="ph ph-lightbulb"></i>
                <div><strong>Tip.</strong> You can customize alert colors via CSS variables.</div>
              </div>
            </div>
          </div>
        ...
        <div class="vd-col-12 vd-col-md-6">
          <div class="vd-card vd-card-glow demo-card">
            <div class="vd-card-header"><h6>Dismissible &amp; With Actions</h6></div>
            <div class="vd-card-body">
              <div
                v-if="!dismissed"
          ...
          <div class="vd-card vd-card-glow demo-card">
            ...
            <div class="vd-card-body">
              <ul>
                ...
                <li>
                  Icons inside alerts should have <code>aria-hidden="true"</code>
