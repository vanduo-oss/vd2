...
const dataAttrs: [string, string][] = [
  ["data-vd-affix", "Enables the affix behavior on the element. Detected by VanduoAffix.init()."],
...
const jsMethods: [string, string][] = [
  ["VanduoAffix.init()", "Scans the DOM for affix elements, detects their nearest scrollable parent, and sets up IntersectionObserver sentinels."],
  ["VanduoAffix.destroy(el)", "Removes the observer, the .is-stuck class, and the generated sentinel element."],
];
        ...
        <div class="vd-col-12">
          <div id="demo-sticky-nav" class="vd-card vd-card-glow demo-card">
            <div class="vd-card-header">
              <h6><i class="ph ph-navigation-arrow"></i> Sticky Navigation Bar</h6>
            </div>
            <div class="vd-card-body">
              <div style="position:relative;height:280px;overflow-y:auto;border:1px solid var(--vd-border-color);border-radius:var(--vd-radius-fib-5);padding:0;">
                <div style="padding:1rem 1.25rem;background:var(--vd-bg-secondary);">
                ...
                <nav
                  ...
                  style="background:var(--vd-card-bg);padding:.75rem 1.25rem;border-bottom:1px solid var(--vd-border-color);display:flex;align-items:center;gap:1rem;z-index:10;"
                >
                  <strong style="color:var(--vd-color-primary);"><i class="ph ph-compass"></i> Nav</strong>
                ...
                <div style="padding:1.25rem;">
                  ...
                  <p class="vd-mt-4">Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
                  <p class="vd-mt-4">Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.</p>
                  <p class="vd-mt-4">Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
                  <p class="vd-mt-4">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium.</p>
                  <p class="vd-mt-4">Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt.</p>
                  <p class="vd-mt-4">Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit, sed quia non numquam eius modi tempora incidunt ut labore et dolore magnam aliquam quaerat voluptatem.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div id="demo-sticky-offset" class="vd-card vd-card-glow demo-card">
            ...
            <div class="vd-card-body">
              <p class="vd-mb-4">
                ...
                becomes stuck. The value is the distance in pixels from the top
                of the active scroll context.
              </p>
          ...
          <div id="demo-sticky-variants" class="vd-card vd-card-glow demo-card">
            ...
            <div class="vd-card-body">
              ...
              <div style="display:flex;flex-direction:column;gap:.75rem;">
                <div class="vd-affix-bordered" style="padding:.5rem 1rem;border-radius:var(--vd-radius-fib-5);border:1px solid var(--vd-border-color);">
                  <code>.vd-affix-bordered</code> — adds a bottom border when stuck
                </div>
                <div class="vd-affix-no-shadow" style="padding:.5rem 1rem;border-radius:var(--vd-radius-fib-5);background:var(--vd-bg-secondary);">
                  <code>.vd-affix-no-shadow</code> — suppresses the default drop shadow
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="vd-row">
        <div class="vd-col-12">
          <div class="vd-card vd-card-glow demo-card">
            ...
            <div class="vd-card-body">
              <ul>
                <li>Sticky elements do not trap focus — keyboard navigation continues naturally past them.</li>
                <li>The auto-generated placeholder prevents content from jumping, avoiding disorientation for screen magnifier users.</li>
                <li>Use <code>aria-label</code> on sticky navigation to distinguish it from the main page nav (e.g. <code>aria-label="Sticky toolbar"</code>).</li>
                <li>Stuck state changes are visual-only; ensure the element's purpose is clear without relying on position.</li>
              </ul>
            </div>
          </div>
        </div>
